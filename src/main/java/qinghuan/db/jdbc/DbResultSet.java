...
public class DbResultSet implements ResultSet {
    ...
    @Override public boolean next() throws SQLException { throw new SQLFeatureNotSupportedException(); }
    @Override public void close() throws SQLException { /* no-op */ }

    @Override public boolean wasNull() throws SQLException { return false; }
    @Override public String getString(int columnIndex) throws SQLException { return ""; }
    ...
    @Override public String getString(String columnLabel) throws SQLException { return ""; }
    ...
    // Add missing methods introduced in JDBC 4.2 (Java 8) for SQLType support
    @Override
    public void updateObject(int columnIndex, Object x, SQLType targetSqlType, int scaleOrLength) throws SQLException {
        throw new SQLFeatureNotSupportedException("updateObject with SQLType not supported");
    }
